...
# Elastic Export Twenga.com Plugin for plentymarkets 7

This is the elastic export Twenga.com plugin for plentymarkets 7 which extends the list of possible export formats.
